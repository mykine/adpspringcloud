...
update ad_creative set url = 'https://www.baidu.com';
INSERT INTO `ad_creative` (`name`, `type`, `material_type`, `height`, `width`, `size`, `duration`, `audit_status`, `user_id`, `url`, `create_time`, `update_time`) VALUES ('第二个创意', 1, 1, 720, 1080, 1024, 0, 1, 10, 'www.baidu.com', '2018-01-01 00:00:00', '2018-01-01 00:00:00');
